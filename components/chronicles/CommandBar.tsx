        ...
        <div className="w-full relative">
            ...
            <form onSubmit={handleFormSubmit} className="relative">
                    ...
                    <div className="absolute bottom-full left-0 mb-2 w-full flex justify-center">
                        <div className="glass-panel rounded-lg p-2 flex items-center gap-3 text-sm font-mono">
                            <img 
                                ...
                                alt="Миниатюра"
                            />
                           <span className="text-cyan-300">Анализ Памяти активен</span>
                           <button 
                               type="button" 
                               onClick={clearAnalysisTarget}
                               data-muza-tooltip="Сбросить выбранный образ"
                ...
                <input
                    ...
                    data-muza-tooltip="Нажмите Enter, чтобы отправить сообщение"
                ...
                {isThinking ? (
                     <button 
                        type="button"
                        onClick={handleStop}
                        data-muza-tooltip="Прервать текущий процесс"
                    ...
                    <button 
                        type="submit" 
                        data-muza-tooltip="Отправить (Send)"
